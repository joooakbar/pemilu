...
import {
  useSuratSuara,
} from '../hooks/useSuratSuara'

import type {
  SuratSuaraProps,
} from '../types/suratsuara.types'

export default function SuratSuara({
  kandidat,
  electionId,
}: SuratSuaraProps) {
  ...
  return (
    <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="w-16 h-16 rounded-full bg-secondary overflow-hidden shrink-0 relative">
                ...
                {k.sanityData?.foto?.asset?.url ? (
                  ...
                  <div className="w-full h-full flex-center text-2xl">
                    👤
                  </div>
      ...
      {confirm && pilihan && (
        ...
        <div
          className="fixed inset-0 z-50 flex-center bg-black/60 px-4"
          onClick={() =>
            setConfirm(false)
          }
        >
          ...
          <div
            className="bg-card rounded-xl p-6 w-full max-w-sm space-y-4 shadow-2xl"
            onClick={(e) =>
              e.stopPropagation()
            }
          >
